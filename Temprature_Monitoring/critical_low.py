...
try:
    ...
    print("The led and buzzer sounds are active and are in criticle condition(LOW).\n")
...
data={
        ...
        "text": f'The temprature has been CRITICAL (LOW). '
    }
try:
    ...
    print(" Error Occured while sendinng alert in Telegram for CRITICAL LOW:  \n", e)
...
try:
    ...
    client.api.account.messages.create(
        to="+918958468703",
        from_="+12107023037",
        body="Alert ! The Current temperature sensor value is CRITICAL(LOW).")
...
try:
    ...
    mail=mailer.send_email("ALERT","The Current temperature sensor value is CRITICAL LOW")
